...
const DisplayData = () => {
  ...
  return (
    <div className="w-2/5 m-auto bg-gradient-to-b from-blue-400 to-yellow-200 h-[35rem] my-14 rounded-md">
      <form action="" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-center gap-2">
            <input type="text" placeholder="Enter a city a city" value={value} onChange={handleInput} className="border rounded-full w-1/2 pl-3 placeholder:text-white border-gray-100 bg-transparent text-white focus:outline-none focus:ring-1 focus:ring-gray-200"/>
    ...
    {weatherData && (
      ...
      {error && (<div className="flex text-center">
